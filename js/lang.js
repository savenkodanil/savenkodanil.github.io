...
const arrLang = {
    "en": {
      ...
      "back-to-top": "TO TOP",
      "go-site":"go to site",
      "project-upsells": "— Project 5",
      "landing-upsells": "Bright modern Landing Page.",
      "about-site-upsells": "Modern information site. Made fully responsive for all devices. You can easily change content without worrying about breaking the architecture.",
    },
    "ua": {
      "hi": "Вітаю",
      ...
      "project-upsells": "— Проект 5",
      "landing-upsells": "Яскравий сучасний Landing Page.",
      "about-site-upsells": "Сучасний інформаційний сайт. Зроблений повністю адаптивно під усі пристрої. Контент спокійно можна змінювати не турбуючись за сбій в архітектурі.",
    }
  }
